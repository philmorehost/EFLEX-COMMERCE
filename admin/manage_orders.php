                    ...
                    <?php if(count($orders) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <?php if ($order['status'] === 'Cancelled' || $order['status'] === 'Awaiting Payment' || $order['status'] === 'Pending'): ?>
                                    <a href="delete_order.php?id=<?php echo $order['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to permanently delete this order? This action cannot be undone.');">Delete</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
